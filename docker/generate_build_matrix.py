...
def _main():
    ...
    nightly_entry = {
        ...
        'CUDA_VERSION': '12.1.0',
        'IMAGE_NAME': 'torch-nightly-2-3-0-20240115-cu121',
        ...
        'PYTORCH_NIGHTLY_VERSION': 'dev20240115+cu121',
        'TAGS': ['mosaicml/pytorch:2.3.0_cu121-nightly20240115-python3.10-ubuntu20.04'],
